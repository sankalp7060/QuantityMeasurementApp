...
{
    /// <summary>
    /// Unit tests for the Inch model class.
    /// These tests validate the behavior of Equals(), GetHashCode(), and ToString()
    /// methods implemented in the Inch class from QuantityMeasurementApp.Models.
    /// </summary>
    [TestClass]
    public class InchTests
    {
        ...
        // Tests symmetric property of Inch.Equals(object?) method
        [TestMethod]
        ...
        // Tests transitive property of Inch.Equals(object?) method
        [TestMethod]
        ...
        // Tests Inch.Equals(object?) method when compared with different object type
        [TestMethod]
        ...
        // Tests consistency of Inch.Equals(object?) method across multiple calls
        [TestMethod]
        ...
        // Tests floating-point precision handling in Inch.Equals(object?) method
        [TestMethod]
        ...
        // Tests Inch.ToString() method for correct string formatting
        [TestMethod]
